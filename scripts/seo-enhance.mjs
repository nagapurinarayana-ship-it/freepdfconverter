...
const seo = {
  ...
  "tools/word-to-pdf.html": ["Word to PDF Converter Free — Private DOCX to PDF | FreePDF Tools", "Convert modern Word DOCX files to PDF in your browser without uploading the source document."],
