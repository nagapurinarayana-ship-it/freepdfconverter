...
const seo = {
  ...
  "about.html": [
    "About FreePDF Tools — Private Browser PDF Utilities",
    "Learn how FreePDF Tools works, why PDF processing happens in your browser, and how the service is designed around privacy and simple document workflows."
  ],
  "how-local-processing.html": [
    "How Local PDF Processing Works — FreePDF Tools",
    "See how FreePDF Tools processes supported PDF files locally in your browser, what stays on your device, and what to expect from local document processing."
  ],
  "unlock-pdf-online.html": [
    "Unlock PDF Online — Remove a Known PDF Password Locally | FreePDF Tools",
  ...
  "merge-pdf-online.html": [
    "Merge PDF Online — Combine PDF Files Privately | FreePDF Tools",
    "Merge multiple PDF files into one document in your browser. Reorder pages and download the combined PDF without uploading your source files."
  ],
  "split-pdf-online.html": [
    "Split PDF Online — Extract or Separate PDF Pages | FreePDF Tools",
    "Split a PDF by page range or create individual PDF pages in your browser. Your source document stays on your device while you create the result."
  ],
  "jpg-to-pdf-online.html": [
    "JPG to PDF Online — Convert Images to PDF Privately | FreePDF Tools",
    "Convert JPG and PNG images to PDF in your browser. Choose practical page sizes, arrange images, and create a PDF without uploading your files."
  ],
  "rotate-pdf-online.html": [
    "Rotate PDF Online — Fix Sideways PDF Pages | FreePDF Tools",
    "Rotate PDF pages by 90, 180 or 270 degrees directly in your browser. Fix sideways or upside-down pages without uploading the document."
  ],
  "crop-pdf-online.html": [
    "Crop PDF Online — Trim PDF Pages and Margins | FreePDF Tools",
    "Crop PDF pages with precise margins in your browser. Remove unwanted borders or blank edges and download the corrected PDF without uploading it."
  ],
  "remove-pdf-metadata-online.html": [
    "Remove PDF Metadata Online — Clean Document Metadata | FreePDF Tools",
    "Remove common PDF metadata such as author, title, subject and keywords in your browser. Create a cleaner copy without uploading the original document."
  ],
  ...
  "tools/organize-pdf.html": ["Organize PDF Pages Online — Reorder or Delete Pages | FreePDF Tools", "Reorder, remove and organize PDF pages in your browser, then save a clean new PDF without uploading the source."],
  ...
  "guides/pdf-to-jpg-vs-png.html": ["PDF to JPG vs PNG — Which Image Format Should You Use? | FreePDF Tools", "Compare JPG and PNG for PDF page conversion, including quality, file size, transparency and practical use cases."],
  ...
  "guides/organize-pdf-pages.html": ["How to Organize PDF Pages — Reorder and Remove Pages | FreePDF Tools", "Learn how to reorder PDF pages, remove unwanted pages and save a clean document without uploading the source file."],
